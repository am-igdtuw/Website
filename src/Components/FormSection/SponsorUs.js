          ...
          {/* <div className="form-container"> */}
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-element">
                ...
                <textarea placeholder="Please share your expectations for our Sponsorship." id="textarea" name="message" rows="4" cols="50" value={formData.message} onChange={handleInputChange}></textarea><br />
              </div>
              <div className="form-element">
