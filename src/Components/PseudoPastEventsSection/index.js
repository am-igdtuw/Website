      ...
      <ServicesP>
        <ServicesContainer>
              <ServicesCard>
                ...
                <InfoRow>
                  <ServicesH1>Orientation and Treasure Hunt</ServicesH1>
                  <ServicesH2>
                   Description/link to insta
                  </ServicesH2>
                </InfoRow>
              </ServicesCard>
            </ServicesContainer>
            ...
            <ServicesContainer>
              <ServicesCard>
                ...
                <InfoRow>
                  <ServicesH1>Find Global Career opportunities 
                    on Web3 and Metaverse</ServicesH1>
                  <ServicesH2>
                   Description/link to insta
                  </ServicesH2>
                </InfoRow>
            ...
            <ServicesContainer>
              <ServicesCard>
                ...
                <InfoRow>
                  <ServicesH1>Intro to Web3 and its Career Scope</ServicesH1>
                  <ServicesH2>
                   Description/link to insta
                  </ServicesH2>
                </InfoRow>
            ...
            <ServicesContainer>
              <ServicesCard>
                ...
                <InfoRow>
                  <ServicesH1>BFF Hackathon</ServicesH1>
                  <ServicesH2>
                   Description/link to insta
                  </ServicesH2>
                </InfoRow>
            ...
            <ServicesContainer>
              <ServicesCard>
                ...
                <InfoRow>
                  <ServicesH1>FastN Session</ServicesH1>
                  <ServicesH2>
                   Description/link to insta
                  </ServicesH2>
                </InfoRow>
            ...
            <ServicesContainer>
              <ServicesCard>
                ...
                <InfoRow>
                  <ServicesH1>Introduction to Crypto
                     V/S Blockchain and Altcoins</ServicesH1>
                  <ServicesH2>
                   Description/link to insta
                  </ServicesH2>
                </InfoRow>
            ...
            <ServicesContainer>
              <ServicesCard>
                ...
                <InfoRow>
                  <ServicesH1>Ideathon</ServicesH1>
                  <ServicesH2>
                   Description/link to insta
                  </ServicesH2>
                </InfoRow>
